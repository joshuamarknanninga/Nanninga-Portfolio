...
import './tailwind.css';
import './styles.css'; // Assuming you will add custom styles here
...
function App() {
  ...
  const toggleWindow = (windowId, action) => {
    setWindows((prevWindows) => {
      ...
      switch (action.type) {
        ...
        case 'move':
          return { ...prevWindows, [windowId]: { ...currentWindow, position: action.payload } };
        default:
          return prevWindows;
      }
    });
  ...
  return (
    <div className="h-screen flex flex-col items-center justify-center bg-gradient-to-br from-gray-200 to-gray-500 relative">
      {/* Dark Mode Toggle */}
      ...
      <div className="flex flex-col space-y-6 items-center justify-center mt-16">
              ...
              >
                ...
                {windowId === 'window4' && (
                  <form className="flex flex-col space-y-2">
                    ...
                    <input type="text" id="name" className="border p-2" required />
                    <label htmlFor="email">Email:</label>
                    <input type="email" id="email" className="border p-2" required />
                    <label htmlFor="message">Message:</label>
                    <textarea id="message" rows="5" className="border p-2" required></textarea>
